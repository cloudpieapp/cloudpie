...
const DocumentaryPage = () => {
  ...
  return (
    <AppLayout>
      <SEO
        title="Documentaries – CloudPie"
        description="Real stories, real people. Explore the world with trending and top-rated documentaries and docuseries streaming on CloudPie."
      />
