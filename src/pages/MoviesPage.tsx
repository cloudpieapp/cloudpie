...
const MoviesPage = () => {
  ...
  return (
    <AppLayout>
      <SEO
        title="Movies – CloudPie"
        description="Browse trending, top-rated, now playing and upcoming movies across every genre. Stream full HD movies free on CloudPie."
        jsonLd={{
          "@type": "CollectionPage",
          name: "Movies – CloudPie",
