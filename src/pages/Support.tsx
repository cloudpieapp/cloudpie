...
const FAQS = [
  { q: "Is CloudPie free?", a: "Yes. CloudPie is free to use and supported by ads." },
...
const Support = () => (
  <AppLayout>
    <SEO title="Help Center – CloudPie" description="Get help with CloudPie — FAQs, support and contact information." />
    <div className="max-w-2xl mx-auto px-5 py-6 text-white">
      ...
      <Link to="/contact" className="mt-5 inline-block px-5 py-3 rounded-xl text-white font-semibold" style={{ background: "#7517FF" }}>
        Contact Support
      </Link>
    </div>
  </AppLayout>
