...
const ShortsPage = () => {
  ...
  return (
    <div className="fixed inset-0 bg-black z-0">
      <SEO title="Shorts – Trailers feed – CloudPie" description="Swipe through trending movie and TV trailers." />
          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 pt-20 pb-24 px-4 bg-gradient-to-t from-black via-black/70 to-transparent z-10 pointer-events-none">
                <p className="text-[11px] font-semibold uppercase tracking-wider text-[#7517FF] mb-1">
              ...
              <div className="absolute right-3 bottom-32 z-20 flex flex-col items-center gap-5">
                ...
                <Link
                  ...
                  className="flex flex-col items-center gap-1 text-white"
                >
                  <span className="w-11 h-11 rounded-full bg-[#7517FF] grid place-items-center shadow-[0_0_20px_rgba(117,23,255,0.6)]">
