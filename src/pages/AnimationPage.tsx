...
const AnimationPage = () => {
  ...
  return (
    <AppLayout>
      <SEO
        title="Animation – CloudPie"
        description="Animated movies and series for every age. Stream Pixar, anime classics, family animation and adult animated shows on CloudPie."
      />
