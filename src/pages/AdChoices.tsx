...
const sections = [
  ...
  { heading: "Advertisers", paragraphs: ["Interested in advertising on CloudPie? Email partners@bingbloom.com."] },
...
export default function AdChoices() {
  return <LegalPage title="Advert Choices" description="Manage your advertising preferences on CloudPie." intro="CloudPie is a free, ad-supported platform. We show non-intrusive banner advertisements to keep the service free for everyone." sections={sections} />;
}
