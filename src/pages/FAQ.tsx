...
const sections = [
  { heading: "Getting Started", groups: [
    { title: "What is BingBloom?", paragraphs: ["BingBloom is a free, ad-supported streaming platform that gives you access to thousands of movies, TV shows, live channels, music, and podcasts. No subscriptions, no credit card required — just pure entertainment."] },
    ...
    { title: "How much does BingBloom cost?", paragraphs: ["BingBloom is completely free. We are an ad-supported platform, which means you'll see occasional banner ads while browsing. We never charge for access to our content."] },
  ]},
  { heading: "Watching on BingBloom", groups: [
    { title: "What devices can I watch on?", paragraphs: ["BingBloom works on any device with a modern web browser — desktop computers, laptops, smartphones, and tablets. You can also install BingBloom as a Progressive Web App (PWA) for an app-like experience."] },
    { title: "Do I need to download anything?", paragraphs: ["No downloads are required to start watching. Simply visit our website and start streaming. For the best experience, we recommend installing the BingBloom PWA on your device."] },
  ...
  { heading: "Content & Features", groups: [
    { title: "What content does BingBloom offer?", paragraphs: ["Movies, TV series, live TV, anime, music videos and podcasts — from Hollywood blockbusters to indie films and the latest episodes."] },
  ...
  { heading: "Billing & Payments", groups: [
    { title: "Is BingBloom really free?", paragraphs: ["Yes — 100% free. Revenue comes from non-intrusive banner advertisements."] },
  ...
  { heading: "Privacy & Legal", groups: [
    { title: "How does BingBloom use my data?", paragraphs: ["See our Privacy Policy for detailed information on how we collect, use and protect your personal information."] },
    { title: "How do I delete my account?", paragraphs: ["Email support@bingbloom.com and our team will process the deletion."] },
  ]},
];

export default function FAQ() {
  return <LegalPage title="Frequently Asked Questions" description="Answers to common BingBloom questions: watching, accounts, troubleshooting, billing and privacy." sections={sections} />;
}
