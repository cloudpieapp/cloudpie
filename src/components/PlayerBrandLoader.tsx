...
/**
 * Branded loader for the player. Shows a bouncing CloudPie logo while the
  ...
  return (
    ...
    >
      <img
        ...
        alt="CloudPie"
        className={`h-14 w-14 rounded-xl drop-shadow-[0_0_24px_rgba(117,23,255,0.55)] ${bouncing ? "animate-bounce" : ""}`}
      />
