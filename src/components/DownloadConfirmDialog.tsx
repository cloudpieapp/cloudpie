      ...
      <DialogContent className="max-w-sm bg-[#0f0f10] border-white/10 text-white">
        <DialogHeader>
          <div className="flex items-center gap-2 mb-1">
            <ShieldAlert className="w-4 h-4 text-[#7517FF]" />
            <DialogTitle className="text-sm font-bold">You're leaving CloudPie</DialogTitle>
          </div>
          <DialogDescription className="text-[11px] text-white/65 leading-relaxed">
            ...
            download page inside an in-app browser. CloudPie doesn't host or control the file.
          </DialogDescription>
        </DialogHeader>
